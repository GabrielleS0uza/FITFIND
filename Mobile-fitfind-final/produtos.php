	...
	try
	{
		...
		else
		{
		 ...
		 echo(	"<h4 class='p-2 text-center'>TUDO PARA O SEU ESTILO</h4> " );
		
		 echo(" <div class='owl-carousel MT-1' > ");
        ...
        {    
                ...
                '<div > 
					...
					<a href="produto.php?prod='. $linha['codigo_produto'].'" style="text-decoration: none;">
                        ...
                        <img src="img/'. $linha['codigo_produto'].'/'.$linha['img_produto'].'" width:"50" alt="" class="imagem11">
