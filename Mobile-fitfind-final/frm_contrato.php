	...
	<div class="row">
		<div class="col-sm-12">
			...
			<form action="" method="post" class="">
				...
				<button name="btoSalvar" class="btn gradient form-control" style="background-color: #BC7ED8; color: white; font-weight: 700;" formaction="contrato_cadastrar.php">Cadastrar</button>				
			</form>
