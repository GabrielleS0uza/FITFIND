			...
			<div class="col-12">
				<div class="row white-menu">
					...
					<div class="col-2 mb-3 mt-3">
						<a class="m" href="">
							<svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" fill="currentColor" class="bi bi-handbag" viewBox="0 0 16 16">
					...
					<hr>
					<div class="row mt-1" >
						<p style="color: #B47CD4;font-size: 16px;">
							<b>Olá visitante!</b>
						</p>
					</div>
					<div class="row border-bottom">
						<p>
							<a class="mouse none" style="font-size: 15px;" href="entrar.php">
				...
				<div class="row mt-2 white-menu">
					<hr>
					<p>
						<a class="mouse none" href="" style="font-size:15px;" >
				...
				<div class="row mt-1 white-menu border-bottom">
					<hr>
					<p>
						<a class="mouse none" href="" style="font-size:15px;">
				...
				<div class="row mt-2 mb-2 white-menu border-bottom">
					<hr>
					<p>
						<a class="mouse none" href="" style="font-size:15px;">
							<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-dots" viewBox="0 0 16 16"><path d="M5 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0zm3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
